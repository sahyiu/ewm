...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - Edit Instructor</title>
...
<body class="font-sans antialiased bg-gray-100">
    ...
    <li class="mb-4">
        ...
        <main class="flex-1 mx-auto mt-10 px-6 bg-white shadow-lg rounded-lg max-w-3xl">
            <!-- Back Button -->
            <div class="mb-4">
                <a href="{{ url()->previous() }}" class="inline-block text-blue-500 hover:text-blue-700">
            ...
            <!-- Form -->
            <form method="POST" action="{{ route('admin.instructor.update', $instructor->id) }}" class="space-y-6">
                @csrf
                @method('PUT')
