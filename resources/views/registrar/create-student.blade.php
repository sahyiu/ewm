<x-app-layout>
    ...
    @if (session('success'))
            <div x-data="{ show: true }" x-show="show" 
                 ...
                 class="fixed top-6 right-6 bg-green-100 text-green-800 p-4 rounded shadow-lg w-72 z-50">
                {{ session('success') }}
            </div>
        @endif
    ...
    <div class="p-6 bg-gray-100 rounded-lg shadow-md mx-auto max-w-4xl">


        <form action="{{ route('registrar.store') }}" method="POST" class="space-y-6">
            @csrf
            <!-- Form Inputs Grid -->
